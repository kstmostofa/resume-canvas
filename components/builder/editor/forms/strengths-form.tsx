...
export function StrengthsForm() {
  const { resumeData, addStrength, updateStrength, removeStrength } =
    useResumeStore();
            ...
            <AccordionContent className="space-y-4 pt-4 px-1">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      updateStrength(strength.id, { title: e.target.value })
                    }
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    value={strength.icon}
                    onValueChange={(value) =>
                      updateStrength(strength.id, { icon: value })
                    }
                  >
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  onChange={(e) =>
                    updateStrength(strength.id, { description: e.target.value })
                  }
